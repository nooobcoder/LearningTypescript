(() => {
  ...
  class e {
    constructor(e, t, n, r) {
      ...
      (this.element = s.firstElementChild), r && (this.element.id = r), this.attach(n);
    }
    attach(e) {
  ...
  function t(e) {
    ...
    return (
      ...
      null != e.minLength && 'string' == typeof e.value && (t = t && e.value.length >= e.minLength),
      null != e.maxLength && 'string' == typeof e.value && (t = t && e.value.length <= e.maxLength),
  ...
  !(function (e, t, n, r) {
    ...
    if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate) l = Reflect.decorate(e, t, n, r);
    else for (var o = e.length - 1; o >= 0; o--) (s = e[o]) && (l = (i < 3 ? s(l) : i > 3 ? s(t, n, l) : s(t, n)) || l);
    i > 3 && l && Object.defineProperty(t, n, l);
  })([n], o.prototype, 'submitHandler', null);
  class a extends e {
    constructor(e, t) {
      super('single-project', e, !1, t.id), (this.project = t), this.configure(), this.renderContent();
    }
    get persons() {
  ...
  !(function (e, t, n, r) {
    ...
    i > 3 && l && Object.defineProperty(t, n, l);
  })([n], a.prototype, 'dragStartHandler', null);
  ...
  class d extends e {
    ...
    dragOverHandler(e) {
      e.dataTransfer &&
        ...
        (e.preventDefault(), this.element.querySelector('ul').classList.add('droppable'));
    }
    dropHandler(e) {
    ...
    configure() {
      this.element.addEventListener('dragover', this.dragOverHandler),
        ...
        l.addListener((e) => {
          const t = e.filter((e) => ('active' === this.type ? e.status === r.Active : e.status === r.Finished));
    ...
    renderProjects() {
      ...
      for (const e of this.assignedProjects) new a(this.element.querySelector('ul').id, e);
    }
  }
  c([n], d.prototype, 'dragOverHandler', null),
    c([n], d.prototype, 'dropHandler', null),
    c([n], d.prototype, 'dragLeaveHandler', null),
    new o(),
    new d('active'),
    new d('finished');
})();
